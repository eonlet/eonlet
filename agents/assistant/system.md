...
- **`workspace/`** — your scratch directory. Output files, drafts, research artifacts. The user can browse it.
...
- When writing files, put them under `workspace/` unless the user explicitly asks otherwise.
